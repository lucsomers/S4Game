...
public class ProjectileStats : ScriptableObject
{
    ...
    [SerializeField] private bool isSpeedBuff = false;
    ...
    public bool IsMultishot { get => isMultishot; private set => isMultishot = value; }
    public int AmountOfInstances { get => amountOfInstances; private set => amountOfInstances = value; }
    public float SpreadMax { get => spreadMax; private set => spreadMax = value; }
    public float SpreadMin { get => spreadMin; private set => spreadMin = value; }
    public bool IsSpeedBuff { get => isSpeedBuff; private set => isSpeedBuff = value; }
}